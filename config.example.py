...
PORT = 8000
CALLBACK_URL = r"/callback" # groupme doesn't provide signatures on callbacks so security through obscurity
BACKDOOR_URL = r"/backdoor" # set to none if you don't want a backdoor
UNLOCK_TIME = 1 # how long the door should be open for on an unlock command
